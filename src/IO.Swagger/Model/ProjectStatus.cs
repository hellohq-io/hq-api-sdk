...
namespace HQ.API.SDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProjectStatus :  IEquatable<ProjectStatus>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectStatus" /> class.
        /// </summary>
        /// <param name="Name">The name of the project status.</param>
        /// <param name="IsInProgress">Whether this project is in progress or not.</param>
        ...
        public ProjectStatus(string Name = null, bool? IsInProgress = null, int? Id = null, int? CreatedBy = null, int? UpdatedBy = null, DateTime? CreatedOn = null, DateTime? UpdatedOn = null)
        {
            this.Name = Name;
        ...
        /// </summary>
        /// <value>The name of the project status</value>
        [DataMember(Name="Name", EmitDefaultValue=false)]
        public string Name { get; set; }
        /// <summary>
        /// Whether this project is in progress or not
        /// </summary>
        /// <value>Whether this project is in progress or not</value>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ProjectStatus);
        }

        /// <summary>
        /// Returns true if ProjectStatus instances are equal
        /// </summary>
        /// <param name="other">Instance of ProjectStatus to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProjectStatus other)
        {
            ...
            return 
                ...
                (
                    ...
                    this.IsInProgress.Equals(other.IsInProgress)
                ) && 
                (
                    this.Id == other.Id ||
                    this.Id != null &&
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.IsInProgress != null)
                    hash = hash * 59 + this.IsInProgress.GetHashCode();
                if (this.Id != null)
