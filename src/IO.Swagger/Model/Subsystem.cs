...
namespace HQ.API.SDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Subsystem :  IEquatable<Subsystem>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Subsystem" /> class.
        /// </summary>
        /// <param name="Name">The name of the subsystem.</param>
        /// <param name="IsMaster">Whether this is the master subsystem.</param>
        ...
        public Subsystem(string Name = null, bool? IsMaster = null, int? Id = null, int? CreatedBy = null, int? UpdatedBy = null, DateTime? CreatedOn = null, DateTime? UpdatedOn = null)
        {
            this.Name = Name;
        ...
        /// <summary>
        /// Whether this is the master subsystem
        /// </summary>
        /// <value>Whether this is the master subsystem</value>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Subsystem);
        }

        /// <summary>
        /// Returns true if Subsystem instances are equal
        /// </summary>
        /// <param name="other">Instance of Subsystem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Subsystem other)
        {
            ...
            return 
                ...
                (
                    ...
                    this.IsMaster != null &&
                    this.IsMaster.Equals(other.IsMaster)
                ) && 
                (
                    this.Id == other.Id ||
                    this.Id != null &&
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.IsMaster != null)
                    hash = hash * 59 + this.IsMaster.GetHashCode();
                if (this.Id != null)
