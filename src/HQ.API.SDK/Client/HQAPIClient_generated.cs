//----------------------
// <auto-generated>
//     Generated using the NSwag toolchain v6.21.6167.23723 (NJsonSchema v5.13.6167.23722) (http://NSwag.org)
// </auto-generated>
//----------------------
...
namespace HQ.API.SDK
{
    ...
    [GeneratedCode("NSwag", "6.21.6167.23723")]
    public partial class HQAPIClient 
    {
        public HQAPIClient() : this("http://localhost:57576") { }
        ...
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public Task<JObject> CompaniesV1_DeleteByIdAsync(int id, string if_Match = null)
        {
        ...
        /// <returns>NoContent</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public async Task<JObject> CompaniesV1_DeleteByIdAsync(CancellationToken cancellationToken, int id, string if_Match = null)
        {
            var url_ = string.Format("{0}/{1}", BaseUrl, "v1/Companies({Id})");
            ...
            if (status_ == "204") 
            {
                var result_ = default(JObject); 
                try
                {
                    if (responseData_.Length > 0)
                    {
                        result_ = JsonConvert.DeserializeObject<JObject>(value); 
    				}
                    return result_; 
                } 
                catch (Exception exception) 
        ...
        /// <returns>NoContent</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public Task<JObject> CompanyTypesV1_DeleteByIdAsync(int id, string if_Match = null)
        {
        ...
        /// <returns>NoContent</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public async Task<JObject> CompanyTypesV1_DeleteByIdAsync(CancellationToken cancellationToken, int id, string if_Match = null)
        {
            var url_ = string.Format("{0}/{1}", BaseUrl, "v1/CompanyTypes({Id})");
        ...
        /// <summary>Returns all config system events</summary>
        /// <param name="expand">Expands related entities inline.</param>
        /// <param name="filter">Filters the results, based on a Boolean condition.</param>
        /// <param name="select">Selects which properties to include in the response.</param>
        /// <param name="orderby">Sorts the results.</param>
        ...
        /// <returns>OK</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public Task<ObservableCollection<ConfigSystemEvent>> ConfigSystemEventsV1_GetAsync(string expand = null, string filter = null, string select = null, string orderby = null, int? top = null, int? skip = null, bool? count = null)
        {
            return ConfigSystemEventsV1_GetAsync(CancellationToken.None, expand, filter, select, orderby, top, skip, count);
        }
        ...
        /// <returns>OK</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public async Task<ObservableCollection<ConfigSystemEvent>> ConfigSystemEventsV1_GetAsync(CancellationToken cancellationToken, string expand = null, string filter = null, string select = null, string orderby = null, int? top = null, int? skip = null, bool? count = null)
        {
            var url_ = string.Format("{0}/{1}?", BaseUrl, "v1/ConfigSystemEvents");
            ...
            if (status_ == "200") 
            {
                var result_ = default(ODataResponseOfListOfConfigSystemEvent); 
                try
                {
                    if (responseData_.Length > 0)
                    {
                        result_ = JsonConvert.DeserializeObject<ODataResponseOfListOfConfigSystemEvent>(value); 
    				}
                    return result_.Value; 
                } 
                catch (Exception exception) 
        ...
        /// <summary>Returns the config system events</summary>
        /// <param name="id">key: Id</param>
        /// <param name="expand">Expands related entities inline.</param>
        /// <param name="select">Selects which properties to include in the response.</param>
        /// <returns>OK</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public Task<ConfigSystemEvent> ConfigSystemEventsV1_GetByIdAsync(int id, string expand = null, string select = null)
        {
            return ConfigSystemEventsV1_GetByIdAsync(CancellationToken.None, id, expand, select);
        }
        ...
        /// <returns>OK</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public async Task<ConfigSystemEvent> ConfigSystemEventsV1_GetByIdAsync(CancellationToken cancellationToken, int id, string expand = null, string select = null)
        {
            var url_ = string.Format("{0}/{1}?", BaseUrl, "v1/ConfigSystemEvents({Id})");
            ...
            if (status_ == "200") 
            {
                var result_ = default(ConfigSystemEvent); 
                try
                {
                    if (responseData_.Length > 0)
                    {
                        result_ = JsonConvert.DeserializeObject<ConfigSystemEvent>(value); 
    				}
                    return result_; 
                } 
                catch (Exception exception) 
        ...
        /// <summary>Returns the system configuration of the specified hostname</summary>
        /// <param name="hostname">key: Hostname</param>
        /// <param name="expand">Expands related entities inline.</param>
        /// <param name="select">Selects which properties to include in the response.</param>
        /// <returns>OK</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public Task<LoginConfig> LoginConfigV1_GetByHostnameAsync(string hostname, string expand = null, string select = null)
        {
            return LoginConfigV1_GetByHostnameAsync(CancellationToken.None, hostname, expand, select);
        }
        ...
        /// <returns>OK</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public async Task<LoginConfig> LoginConfigV1_GetByHostnameAsync(CancellationToken cancellationToken, string hostname, string expand = null, string select = null)
        {
            var url_ = string.Format("{0}/{1}?", BaseUrl, "v1/LoginConfig('{Hostname}')");
    
            if (hostname == null)
                throw new ArgumentNullException("hostname");
            url_ = url_.Replace("{Hostname}", Uri.EscapeDataString(hostname.ToString()));
            ...
            if (status_ == "200") 
            {
                var result_ = default(LoginConfig); 
                try
                {
                    if (responseData_.Length > 0)
                    {
                        result_ = JsonConvert.DeserializeObject<LoginConfig>(value); 
    				}
                    return result_; 
                } 
                catch (Exception exception) 
        ...
        /// <summary>Returns the menu items configuration of the specified hostname</summary>
        /// <param name="expand">Expands related entities inline.</param>
        /// <param name="filter">Filters the results, based on a Boolean condition.</param>
        /// <param name="select">Selects which properties to include in the response.</param>
        /// <param name="orderby">Sorts the results.</param>
        ...
        /// <returns>OK</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public Task<ObservableCollection<MenuItem>> MenuItemsV1_GetAsync(string expand = null, string filter = null, string select = null, string orderby = null, int? top = null, int? skip = null, bool? count = null)
        {
            return MenuItemsV1_GetAsync(CancellationToken.None, expand, filter, select, orderby, top, skip, count);
        }
        ...
        /// <returns>OK</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public async Task<ObservableCollection<MenuItem>> MenuItemsV1_GetAsync(CancellationToken cancellationToken, string expand = null, string filter = null, string select = null, string orderby = null, int? top = null, int? skip = null, bool? count = null)
        {
            var url_ = string.Format("{0}/{1}?", BaseUrl, "v1/MenuItems");
            ...
            if (status_ == "200") 
            {
                var result_ = default(ODataResponseOfListOfMenuItem); 
                try
                {
                    if (responseData_.Length > 0)
                    {
                        result_ = JsonConvert.DeserializeObject<ODataResponseOfListOfMenuItem>(value); 
    				}
                    return result_.Value; 
                } 
                catch (Exception exception) 
        ...
        /// <returns>OK</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public Task<ObservableCollection<MenuItem>> MenuItemsV1_GetByIdAsync(int id, string expand = null, string select = null)
        {
            return MenuItemsV1_GetByIdAsync(CancellationToken.None, id, expand, select);
        }
        ...
        /// <returns>OK</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public async Task<ObservableCollection<MenuItem>> MenuItemsV1_GetByIdAsync(CancellationToken cancellationToken, int id, string expand = null, string select = null)
        {
            var url_ = string.Format("{0}/{1}?", BaseUrl, "v1/MenuItems({Id})");
        ...
        /// <returns>OK</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public Task<ObservableCollection<ResponseTimeLog>> ResponseTimeLogsV1_GetAsync(string expand = null, string filter = null, string select = null, string orderby = null, int? top = null, int? skip = null, bool? count = null)
        {
            return ResponseTimeLogsV1_GetAsync(CancellationToken.None, expand, filter, select, orderby, top, skip, count);
        }
        ...
        /// <returns>OK</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public async Task<ObservableCollection<ResponseTimeLog>> ResponseTimeLogsV1_GetAsync(CancellationToken cancellationToken, string expand = null, string filter = null, string select = null, string orderby = null, int? top = null, int? skip = null, bool? count = null)
        {
            var url_ = string.Format("{0}/{1}?", BaseUrl, "v1/ResponseTimeLogs");
            ...
            if (status_ == "200") 
            {
                var result_ = default(ODataResponseOfListOfResponseTimeLog); 
                try
                {
                    if (responseData_.Length > 0)
                    {
                        result_ = JsonConvert.DeserializeObject<ODataResponseOfListOfResponseTimeLog>(value); 
    				}
                    return result_.Value; 
                } 
                catch (Exception exception) 
        ...
        /// <returns>OK</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public Task<ResponseTimeLog> ResponseTimeLogsV1_GetByIdAsync(int id, string expand = null, string select = null)
        {
            return ResponseTimeLogsV1_GetByIdAsync(CancellationToken.None, id, expand, select);
        }
        ...
        /// <returns>OK</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public async Task<ResponseTimeLog> ResponseTimeLogsV1_GetByIdAsync(CancellationToken cancellationToken, int id, string expand = null, string select = null)
        {
            var url_ = string.Format("{0}/{1}?", BaseUrl, "v1/ResponseTimeLogs({Id})");
            ...
            if (status_ == "200") 
            {
                var result_ = default(ResponseTimeLog); 
                try
                {
                    if (responseData_.Length > 0)
                    {
                        result_ = JsonConvert.DeserializeObject<ResponseTimeLog>(value); 
    				}
                    return result_; 
                } 
                catch (Exception exception) 
        ...
        /// <returns>OK</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public Task<Document> DocumentsV1_GetByIdAsync(int id, string expand = null, string select = null)
        {
            return DocumentsV1_GetByIdAsync(CancellationToken.None, id, expand, select);
        }
        ...
        /// <returns>OK</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public async Task<Document> DocumentsV1_GetByIdAsync(CancellationToken cancellationToken, int id, string expand = null, string select = null)
        {
            var url_ = string.Format("{0}/{1}?", BaseUrl, "v1/Documents({Id})");
            ...
            if (status_ == "200") 
            {
                var result_ = default(Document); 
                try
                {
                    if (responseData_.Length > 0)
                    {
                        result_ = JsonConvert.DeserializeObject<Document>(value); 
    				}
                    return result_; 
                } 
                catch (Exception exception) 
        ...
        public async Task<Invoice> InvoicesV1_PostAsync(CancellationToken cancellationToken, Invoice invoice, string expand = null, string select = null)
        {
            ...
            var request_ = new HttpRequestMessage();
            PrepareRequest(client_, ref url_);
            var stringContent = JsonConvert.SerializeObject(invoice);
            var content_ = new StringContent(stringContent);
            content_.Headers.ContentType.MediaType = "application/json";
            request_.Content = content_;
            request_.Method = new HttpMethod("POST");
        ...
        /// <returns>NoContent</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public Task<JObject> InvoicesV1_DeleteByIdAsync(int id, string if_Match = null)
        {
        ...
        /// <returns>NoContent</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public async Task<JObject> InvoicesV1_DeleteByIdAsync(CancellationToken cancellationToken, int id, string if_Match = null)
        {
            var url_ = string.Format("{0}/{1}", BaseUrl, "v1/Invoices({Id})");
        ...
        /// <param name="id">key: Id</param>
        /// <param name="invoicesV1CreateCancellationParameters">No parameters necessary. Ignore parameter 'do'.</param>
        /// <param name="expand">Expands related entities inline.</param>
        /// <param name="select">Selects which properties to include in the response.</param>
        /// <returns>Created</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public Task<Invoice> InvoicesV1_CreateCancellationByIdAsync(int id, InvoicesV1CreateCancellationParameters invoicesV1CreateCancellationParameters = null, string expand = null, string select = null)
        {
            return InvoicesV1_CreateCancellationByIdAsync(CancellationToken.None, id, invoicesV1CreateCancellationParameters, expand, select);
        }
        ...
        /// <returns>Created</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public async Task<Invoice> InvoicesV1_CreateCancellationByIdAsync(CancellationToken cancellationToken, int id, InvoicesV1CreateCancellationParameters invoicesV1CreateCancellationParameters = null, string expand = null, string select = null)
        {
            ...
            var request_ = new HttpRequestMessage();
            PrepareRequest(client_, ref url_);
            var stringContent = JsonConvert.SerializeObject(invoicesV1CreateCancellationParameters);
            var content_ = new StringContent(stringContent);
            content_.Headers.ContentType.MediaType = "application/json";
            request_.Content = content_;
            request_.Method = new HttpMethod("POST");
        ...
        /// <param name="id">key: Id</param>
        /// <param name="invoicesV1CopyDocumentParameters">No parameters necessary. Ignore parameter 'do'.</param>
        /// <param name="expand">Expands related entities inline.</param>
        /// <param name="select">Selects which properties to include in the response.</param>
        /// <returns>Created</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public Task<Invoice> InvoicesV1_CopyDocumentByIdAsync(int id, InvoicesV1CopyDocumentParameters invoicesV1CopyDocumentParameters = null, string expand = null, string select = null)
        {
            return InvoicesV1_CopyDocumentByIdAsync(CancellationToken.None, id, invoicesV1CopyDocumentParameters, expand, select);
        }
        ...
        /// <returns>Created</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public async Task<Invoice> InvoicesV1_CopyDocumentByIdAsync(CancellationToken cancellationToken, int id, InvoicesV1CopyDocumentParameters invoicesV1CopyDocumentParameters = null, string expand = null, string select = null)
        {
            var url_ = string.Format("{0}/{1}?", BaseUrl, "v1/Invoices({Id})/do.CopyDocument");
            ...
            var request_ = new HttpRequestMessage();
            PrepareRequest(client_, ref url_);
            var stringContent = JsonConvert.SerializeObject(invoicesV1CopyDocumentParameters);
            var content_ = new StringContent(stringContent);
            content_.Headers.ContentType.MediaType = "application/json";
            request_.Content = content_;
            request_.Method = new HttpMethod("POST");
        ...
        /// <returns>Ok</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public Task<JObject> InvoicesV1_AttachAdvanceInvoiceByIdAsync(int id, InvoicesV1AttachAdvanceInvoiceParameters invoicesV1AttachAdvanceInvoiceParameters)
        {
        ...
        /// <returns>Ok</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public async Task<JObject> InvoicesV1_AttachAdvanceInvoiceByIdAsync(CancellationToken cancellationToken, int id, InvoicesV1AttachAdvanceInvoiceParameters invoicesV1AttachAdvanceInvoiceParameters)
        {
            ...
            var request_ = new HttpRequestMessage();
            PrepareRequest(client_, ref url_);
            var stringContent = JsonConvert.SerializeObject(invoicesV1AttachAdvanceInvoiceParameters);
            var content_ = new StringContent(stringContent);
            content_.Headers.ContentType.MediaType = "application/json";
            request_.Content = content_;
            request_.Method = new HttpMethod("POST");
        ...
        /// <summary>Changes the status of a document</summary>
        /// <param name="id">key: Id</param>
        /// <param name="invoicesV1SetStatusParameters">The parameter object, where 'status' is the new status to set</param>
        /// <returns>Ok</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public Task<JObject> InvoicesV1_SetStatusByIdAsync(int id, InvoicesV1SetStatusParameters invoicesV1SetStatusParameters)
        {
        ...
        /// <returns>Ok</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public async Task<JObject> InvoicesV1_SetStatusByIdAsync(CancellationToken cancellationToken, int id, InvoicesV1SetStatusParameters invoicesV1SetStatusParameters)
        {
            ...
            var request_ = new HttpRequestMessage();
            PrepareRequest(client_, ref url_);
            var stringContent = JsonConvert.SerializeObject(invoicesV1SetStatusParameters);
            var content_ = new StringContent(stringContent);
            content_.Headers.ContentType.MediaType = "application/json";
            request_.Content = content_;
            request_.Method = new HttpMethod("POST");
        ...
        public async Task<Quotation> QuotationsV1_PostAsync(CancellationToken cancellationToken, Quotation quotation, string expand = null, string select = null)
        {
            ...
            var request_ = new HttpRequestMessage();
            PrepareRequest(client_, ref url_);
            var stringContent = JsonConvert.SerializeObject(quotation);
            var content_ = new StringContent(stringContent);
            content_.Headers.ContentType.MediaType = "application/json";
            request_.Content = content_;
            request_.Method = new HttpMethod("POST");
        ...
        /// <summary>Creates the final invoice for the quoation</summary>
        /// <param name="id">key: Id</param>
        /// <param name="quotationsV1CreateFinalInvoiceParameters">No parameters necessary. Ignore paramater 'do'.</param>
        /// <param name="expand">Expands related entities inline.</param>
        /// <param name="select">Selects which properties to include in the response.</param>
        /// <returns>Created</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public Task<Invoice> QuotationsV1_CreateFinalInvoiceByIdAsync(int id, QuotationsV1CreateFinalInvoiceParameters quotationsV1CreateFinalInvoiceParameters = null, string expand = null, string select = null)
        {
            return QuotationsV1_CreateFinalInvoiceByIdAsync(CancellationToken.None, id, quotationsV1CreateFinalInvoiceParameters, expand, select);
        }
        ...
        /// <returns>Created</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public async Task<Invoice> QuotationsV1_CreateFinalInvoiceByIdAsync(CancellationToken cancellationToken, int id, QuotationsV1CreateFinalInvoiceParameters quotationsV1CreateFinalInvoiceParameters = null, string expand = null, string select = null)
        {
            ...
            var request_ = new HttpRequestMessage();
            PrepareRequest(client_, ref url_);
            var stringContent = JsonConvert.SerializeObject(quotationsV1CreateFinalInvoiceParameters);
            var content_ = new StringContent(stringContent);
            content_.Headers.ContentType.MediaType = "application/json";
            request_.Content = content_;
            request_.Method = new HttpMethod("POST");
        ...
        /// <summary>Creates a copy of the quotation</summary>
        /// <param name="id">key: Id</param>
        /// <param name="quotationsV1CopyDocumentParameters">No parameters necessary. Ignore paramater 'do'.</param>
        /// <param name="expand">Expands related entities inline.</param>
        /// <param name="select">Selects which properties to include in the response.</param>
        /// <returns>Created</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public Task<Quotation> QuotationsV1_CopyDocumentByIdAsync(int id, QuotationsV1CopyDocumentParameters quotationsV1CopyDocumentParameters = null, string expand = null, string select = null)
        {
            return QuotationsV1_CopyDocumentByIdAsync(CancellationToken.None, id, quotationsV1CopyDocumentParameters, expand, select);
        }
        ...
        /// <returns>Created</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public async Task<Quotation> QuotationsV1_CopyDocumentByIdAsync(CancellationToken cancellationToken, int id, QuotationsV1CopyDocumentParameters quotationsV1CopyDocumentParameters = null, string expand = null, string select = null)
        {
            var url_ = string.Format("{0}/{1}?", BaseUrl, "v1/Quotations({Id})/do.CopyDocument");
            ...
            var request_ = new HttpRequestMessage();
            PrepareRequest(client_, ref url_);
            var stringContent = JsonConvert.SerializeObject(quotationsV1CopyDocumentParameters);
            var content_ = new StringContent(stringContent);
            content_.Headers.ContentType.MediaType = "application/json";
            request_.Content = content_;
            request_.Method = new HttpMethod("POST");
        ...
        /// <summary>Creates an advance invoice for the quotation</summary>
        /// <param name="id">key: Id</param>
        ...
        public async Task<Invoice> QuotationsV1_CreateAdvanceInvoiceByIdAsync(CancellationToken cancellationToken, int id, QuotationsV1CreateAdvanceInvoiceParameters quotationsV1CreateAdvanceInvoiceParameters, string expand = null, string select = null)
        {
            ...
            var request_ = new HttpRequestMessage();
            PrepareRequest(client_, ref url_);
            var stringContent = JsonConvert.SerializeObject(quotationsV1CreateAdvanceInvoiceParameters);
            var content_ = new StringContent(stringContent);
            content_.Headers.ContentType.MediaType = "application/json";
            request_.Content = content_;
            request_.Method = new HttpMethod("POST");
        ...
        /// <summary>Creates an invoice for the quotation</summary>
        /// <param name="id">key: Id</param>
        /// <param name="quotationsV1CreateInvoiceParameters">No parameters necessary. Ignore paramater 'do'.</param>
        /// <param name="expand">Expands related entities inline.</param>
        /// <param name="select">Selects which properties to include in the response.</param>
        /// <returns>Created</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public Task<Invoice> QuotationsV1_CreateInvoiceByIdAsync(int id, QuotationsV1CreateInvoiceParameters quotationsV1CreateInvoiceParameters = null, string expand = null, string select = null)
        {
            return QuotationsV1_CreateInvoiceByIdAsync(CancellationToken.None, id, quotationsV1CreateInvoiceParameters, expand, select);
        }
        ...
        /// <returns>Created</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public async Task<Invoice> QuotationsV1_CreateInvoiceByIdAsync(CancellationToken cancellationToken, int id, QuotationsV1CreateInvoiceParameters quotationsV1CreateInvoiceParameters = null, string expand = null, string select = null)
        {
            ...
            var request_ = new HttpRequestMessage();
            PrepareRequest(client_, ref url_);
            var stringContent = JsonConvert.SerializeObject(quotationsV1CreateInvoiceParameters);
            var content_ = new StringContent(stringContent);
            content_.Headers.ContentType.MediaType = "application/json";
            request_.Content = content_;
            request_.Method = new HttpMethod("POST");
        ...
        /// <returns>NoContent</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public Task<JObject> ProjectRolesV1_DeleteByIdAsync(int id, string if_Match = null)
        {
        ...
        /// <returns>NoContent</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public async Task<JObject> ProjectRolesV1_DeleteByIdAsync(CancellationToken cancellationToken, int id, string if_Match = null)
        {
            var url_ = string.Format("{0}/{1}", BaseUrl, "v1/ProjectRoles({Id})");
        ...
        /// <returns>NoContent</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public Task<JObject> ProjectStatusV1_DeleteByIdAsync(int id, string if_Match = null)
        {
        ...
        /// <returns>NoContent</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public async Task<JObject> ProjectStatusV1_DeleteByIdAsync(CancellationToken cancellationToken, int id, string if_Match = null)
        {
            var url_ = string.Format("{0}/{1}", BaseUrl, "v1/ProjectStatus({Id})");
        ...
        /// <summary>Returns all proejct tasks</summary>
        /// <param name="expand">Expands related entities inline.</param>
        /// <param name="filter">Filters the results, based on a Boolean condition.</param>
        /// <param name="select">Selects which properties to include in the response.</param>
        /// <param name="orderby">Sorts the results.</param>
        ...
        /// <summary>Returns all task assignments</summary>
        /// <param name="expand">Expands related entities inline.</param>
        /// <param name="filter">Filters the results, based on a Boolean condition.</param>
        /// <param name="select">Selects which properties to include in the response.</param>
        /// <param name="orderby">Sorts the results.</param>
        ...
        /// <summary>Returns the taskassignment with the specified id</summary>
        /// <param name="id">key: Id</param>
        /// <param name="expand">Expands related entities inline.</param>
        /// <param name="select">Selects which properties to include in the response.</param>
        /// <returns>OK</returns>
        ...
        /// <returns>Created</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public Task<UserAbsence> UserAbsencesV1_PostAsync(UserAbsence userAbsence, string expand = null, string select = null)
        {
        ...
        /// <returns>Created</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public async Task<UserAbsence> UserAbsencesV1_PostAsync(CancellationToken cancellationToken, UserAbsence userAbsence, string expand = null, string select = null)
        {
            var url_ = string.Format("{0}/{1}?", BaseUrl, "v1/UserAbsences");
        ...
        /// <returns>OK</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public Task<JObject> UserAbsencesV1_DeleteByIdAsync(int id, string if_Match = null)
        {
        ...
        /// <returns>OK</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public async Task<JObject> UserAbsencesV1_DeleteByIdAsync(CancellationToken cancellationToken, int id, string if_Match = null)
        {
            var url_ = string.Format("{0}/{1}", BaseUrl, "v1/UserAbsences({Id})");
        ...
        /// <returns>NoContent</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public Task<JObject> UserReportingsV1_DeleteByIdAsync(int id, string if_Match = null)
        {
        ...
        /// <returns>NoContent</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public async Task<JObject> UserReportingsV1_DeleteByIdAsync(CancellationToken cancellationToken, int id, string if_Match = null)
        {
            var url_ = string.Format("{0}/{1}", BaseUrl, "v1/UserReportings({Id})");
    ...
    [GeneratedCode("NJsonSchema", "5.13.6167.23722")]
    ...
    { 
        ...
        /// <summary>The Firstname of the contact person</summary>
        ...
        /// <summary>The Lastname of the contact person</summary>
        ...
        /// <summary>The id of the company, where contact person belongs to</summary>
    ...
    [JsonObject(MemberSerialization.OptIn)]
    [GeneratedCode("NJsonSchema", "5.13.6167.23722")]
    public partial class ODataResponseOfListOfConfigSystemEvent : INotifyPropertyChanged
    { 
        private string _oDataContext; 
        private ObservableCollection<ConfigSystemEvent> _value;
        ...
        [JsonProperty("value", Required = Required.Default, NullValueHandling = NullValueHandling.Ignore)]
        public ObservableCollection<ConfigSystemEvent> Value
        {
            get { return _value; }
            set 
            {
    ...
    [JsonObject(MemberSerialization.OptIn)]
    [GeneratedCode("NJsonSchema", "5.13.6167.23722")]
    public partial class ConfigSystemEvent : INotifyPropertyChanged
    { 
        private string _propertyName; 
        private int? _entityId; 
        private string _oldValue; 
        private string _newValue; 
        private ConfigSystemEventType? _type; 
        ...
        /// <summary>The name of the property, which changed</summary>
        ...
        /// <summary>The id of the object which changed</summary>
        ...
        /// <summary>The operation type, changed, created or removed</summary>
        [JsonProperty("Type", Required = Required.Default, NullValueHandling = NullValueHandling.Ignore)]
        [JsonConverter(typeof(StringEnumConverter))]
        public ConfigSystemEventType? Type
        {
            get { return _type; }
            set 
            {
        ...
        /// <summary>The name of the database object, which changed</summary>
    ...
    [JsonObject(MemberSerialization.OptIn)]
    [GeneratedCode("NJsonSchema", "5.13.6167.23722")]
    public partial class ODataResponseOfListOfMenuItem : INotifyPropertyChanged
    { 
        private string _oDataContext; 
        private ObservableCollection<MenuItem> _value;
        ...
        [JsonProperty("value", Required = Required.Default, NullValueHandling = NullValueHandling.Ignore)]
        public ObservableCollection<MenuItem> Value
        {
            get { return _value; }
            set 
            {
    ...
    [JsonObject(MemberSerialization.OptIn)]
    [GeneratedCode("NJsonSchema", "5.13.6167.23722")]
    public partial class ODataResponseOfListOfResponseTimeLog : INotifyPropertyChanged
    { 
        private string _oDataContext; 
        private ObservableCollection<ResponseTimeLog> _value;
        ...
        [JsonProperty("value", Required = Required.Default, NullValueHandling = NullValueHandling.Ignore)]
        public ObservableCollection<ResponseTimeLog> Value
        {
            get { return _value; }
            set 
            {
    ...
    [JsonObject(MemberSerialization.OptIn)]
    [GeneratedCode("NJsonSchema", "5.13.6167.23722")]
    public partial class ResponseTimeLog : INotifyPropertyChanged
    { 
        private string _url; 
    ...
    { 
        ...
        private InternalCompany _internalCompany = new InternalCompany(); 
        private int _id; 
        private int? _createdBy; 
        private int? _updatedBy; 
        private DateTime? _createdOn; 
    ...
    { 
        ...
        private HQFile _documentImage = new HQFile(); 
        private int _id; 
        private int? _createdBy; 
        private int? _updatedBy; 
        private DateTime? _createdOn; 
        ...
        public HQFile DocumentImage
        {
            get { return _documentImage; }
            set 
            {
                if (_documentImage != value)
                {
    ...
    { 
        ...
        /// <summary>The birthdate of the user</summary>
        ...
        /// <summary>The customfields of the user</summary>
        [JsonProperty("CustomFields", Required = Required.Default, NullValueHandling = NullValueHandling.Ignore)]
        public ObservableCollection<CustomField> CustomFields
        {
            get { return _customFields; }
    ...
    { 
        private string _number; 
        private Company _company = new Company(); 
        private LeadStatus _status = new LeadStatus(); 
        private int? _statusId; 
        private DateTime? _cashOn; 
        private int? _closingProbability; 
        private double? _volume; 
        private int? _companyId; 
        private ObservableCollection<CustomField> _customFields; 
        private User _responsibleUser = new User(); 
        ...
        /// <summary>Probability of closing the lead in percent</summary>
        [JsonProperty("ClosingProbability", Required = Required.Default, NullValueHandling = NullValueHandling.Ignore)]
        public int? ClosingProbability
        {
            get { return _closingProbability; }
            set 
            {
                if (_closingProbability != value)
                {
                    _closingProbability = value; 
                    RaisePropertyChanged();
                }
            }
        }
    
        /// <summary>The leadvolume, when closing the lead</summary>
        ...
        /// <summary>The customfields of the lead</summary>
        [JsonProperty("CustomFields", Required = Required.Default, NullValueHandling = NullValueHandling.Ignore)]
        public ObservableCollection<CustomField> CustomFields
        {
            get { return _customFields; }
        ...
        /// <summary>The user responsible for the lead</summary>
        ...
        /// <summary>The user id of the user responsible for the lead</summary>
    ...
    { 
        ...
        private ObservableCollection<FileRelation> _fileRelations; 
        private int _id; 
        private int? _createdBy; 
        private int? _updatedBy; 
        private DateTime? _createdOn; 
        ...
        /// <summary>If the file entity is a folder it's true</summary>
        [JsonProperty("IsFolder", Required = Required.Default, NullValueHandling = NullValueHandling.Ignore)]
        ...
        public ObservableCollection<FileRelation> FileRelations
        {
            get { return _fileRelations; }
            set 
            {
                if (_fileRelations != value)
                {
                    _fileRelations = value; 
                    RaisePropertyChanged();
                }
            }
        }
    ...
    [JsonObject(MemberSerialization.OptIn)]
    [GeneratedCode("NJsonSchema", "5.13.6167.23722")]
    public partial class FileRelation : INotifyPropertyChanged
    { 
        private int? _projectId; 
        private Project _project = new Project(); 
        ...
        /// <summary>The id of the project, the file belongs to</summary>
        [JsonProperty("ProjectId", Required = Required.Default, NullValueHandling = NullValueHandling.Ignore)]
        public int? ProjectId
        {
            get { return _projectId; }
        ...
        /// <summary>The project the file belongs to</summary>
        [JsonProperty("Project", Required = Required.Default, NullValueHandling = NullValueHandling.Ignore)]
        public Project Project
        {
            get { return _project; }
        ...
        /// <summary>The article the file belongs to</summary>
        ...
        /// <summary>The article id the files belongs to</summary>
    ...
    { 
        ...
        private ObservableCollection<CustomField> _customFields; 
        private ObservableCollection<HQFile> _files; 
        private int _id; 
        private int? _createdBy; 
        private int? _updatedBy; 
        private DateTime? _createdOn; 
        ...
        public ObservableCollection<HQFile> Files
        {
            get { return _files; }
            set 
            {
    ...
    /// <summary>A document position represents an individual cost item on an invoice or quotation.</summary>
    [JsonObject(MemberSerialization.OptIn)]
    [GeneratedCode("NJsonSchema", "5.13.6167.23722")]
    ...
    /// <summary>The tasks of a project</summary>
    [JsonObject(MemberSerialization.OptIn)]
    [GeneratedCode("NJsonSchema", "5.13.6167.23722")]
    ...
    { 
        ...
        private TaskType _taskType = new TaskType(); 
        private TaskTypeStatus _taskTypeStatus = new TaskTypeStatus(); 
        ...
        /// <summary>The Assignments of users to a specific task</summary>
        ...
        /// <summary>The project of the task</summary>
        [JsonProperty("Project", Required = Required.Default, NullValueHandling = NullValueHandling.Ignore)]
        public Project Project
        {
            get { return _project; }
        ...
        /// <summary>The ParentId of the task for building an hierachy</summary>
        [JsonProperty("ParentId", Required = Required.Default, NullValueHandling = NullValueHandling.Ignore)]
        public int? ParentId
        {
            get { return _parentId; }
        ...
        /// <summary>The Projectid of the task</summary>
        [JsonProperty("ProjectId", Required = Required.Default, NullValueHandling = NullValueHandling.Ignore)]
        public int? ProjectId
        {
            get { return _projectId; }
        ...
        /// <summary>The state of the task, if it's open or done</summary>
        ...
        /// <summary>The starttime of the task</summary>
        ...
        /// <summary>The endtime of the task</summary>
        ...
        /// <summary>The tasktype id</summary>
        ...
        /// <summary>The tasktypestatus of the task</summary>
        ...
        [JsonProperty("TaskDependencies", Required = Required.Default, NullValueHandling = NullValueHandling.Ignore)]
        public ObservableCollection<TaskDependency> TaskDependencies
        {
            get { return _taskDependencies; }
            set 
            {
                if (_taskDependencies != value)
                {
    ...
    { 
        ...
        /// <summary>The name of the tasktype status</summary>
        [JsonProperty("Name", Required = Required.Default, NullValueHandling = NullValueHandling.Ignore)]
        public string Name
        {
            get { return _name; }
        ...
        /// <summary>The id of the tasktype</summary>
        [JsonProperty("TaskTypeId", Required = Required.Default, NullValueHandling = NullValueHandling.Ignore)]
        public int? TaskTypeId
        {
            get { return _taskTypeId; }
        ...
        /// <summary>The tasktype the status is related to</summary>
        [JsonProperty("TaskType", Required = Required.Default, NullValueHandling = NullValueHandling.Ignore)]
        public TaskType TaskType
        {
            get { return _taskType; }
    ...
    [JsonObject(MemberSerialization.OptIn)]
    [GeneratedCode("NJsonSchema", "5.13.6167.23722")]
    public partial class TaskDependency : INotifyPropertyChanged
    { 
        private Task _fromTask = new Task(); 
        private int? _fromTaskId; 
        private Task _toTask = new Task(); 
        ...
        /// <summary>The task id which is the successor to the predecessor task</summary>
        [JsonProperty("ToTaskId", Required = Required.Default, NullValueHandling = NullValueHandling.Ignore)]
        public int? ToTaskId
        {
            get { return _toTaskId; }
            set 
            {
                if (_toTaskId != value)
                {
    ...
    [JsonObject(MemberSerialization.OptIn)]
    [GeneratedCode("NJsonSchema", "5.13.6167.23722")]
    public partial class InvoicesV1CreateCancellationParameters : INotifyPropertyChanged
    { 
        private bool? _do;
    
        [JsonProperty("do", Required = Required.Default, NullValueHandling = NullValueHandling.Ignore)]
        public bool? Do
        {
            get { return _do; }
            set 
        ...
        public static InvoicesV1CreateCancellationParameters FromJson(string data)
        {
            return JsonConvert.DeserializeObject<InvoicesV1CreateCancellationParameters>(data);
        }
    ...
    [JsonObject(MemberSerialization.OptIn)]
    [GeneratedCode("NJsonSchema", "5.13.6167.23722")]
    public partial class InvoicesV1CopyDocumentParameters : INotifyPropertyChanged
    { 
        private bool? _do;
        ...
        public static InvoicesV1CopyDocumentParameters FromJson(string data)
        {
            return JsonConvert.DeserializeObject<InvoicesV1CopyDocumentParameters>(data);
        }
    ...
    [JsonObject(MemberSerialization.OptIn)]
    [GeneratedCode("NJsonSchema", "5.13.6167.23722")]
    public partial class InvoicesV1AttachAdvanceInvoiceParameters : INotifyPropertyChanged
    { 
        private double _advanceInvoiceId;
    
        [JsonProperty("advanceInvoiceId", Required = Required.Always)]
        public double AdvanceInvoiceId
        {
            get { return _advanceInvoiceId; }
            set 
            {
                if (_advanceInvoiceId != value)
                {
                    _advanceInvoiceId = value; 
                    RaisePropertyChanged();
                }
            }
        }
    ...
    [JsonObject(MemberSerialization.OptIn)]
    [GeneratedCode("NJsonSchema", "5.13.6167.23722")]
    public partial class InvoicesV1SetStatusParameters : INotifyPropertyChanged
    { 
        private int _status;
    ...
    [JsonObject(MemberSerialization.OptIn)]
    [GeneratedCode("NJsonSchema", "5.13.6167.23722")]
    public partial class QuotationsV1CreateFinalInvoiceParameters : INotifyPropertyChanged
    { 
        private bool? _do;
        ...
        public static QuotationsV1CreateFinalInvoiceParameters FromJson(string data)
        {
            return JsonConvert.DeserializeObject<QuotationsV1CreateFinalInvoiceParameters>(data);
        }
    ...
    [JsonObject(MemberSerialization.OptIn)]
    [GeneratedCode("NJsonSchema", "5.13.6167.23722")]
    public partial class QuotationsV1CopyDocumentParameters : INotifyPropertyChanged
    { 
        private bool? _do;
        ...
        public static QuotationsV1CopyDocumentParameters FromJson(string data)
        {
            return JsonConvert.DeserializeObject<QuotationsV1CopyDocumentParameters>(data);
        }
    ...
    [JsonObject(MemberSerialization.OptIn)]
    [GeneratedCode("NJsonSchema", "5.13.6167.23722")]
    public partial class QuotationsV1CreateAdvanceInvoiceParameters : INotifyPropertyChanged
    { 
        private int _invoiceType; 
        private double _advanceInvoiceValue;
        ...
        public double AdvanceInvoiceValue
        {
            get { return _advanceInvoiceValue; }
            set 
            {
                if (_advanceInvoiceValue != value)
                {
                    _advanceInvoiceValue = value; 
                    RaisePropertyChanged();
                }
            }
        }
    ...
    [JsonObject(MemberSerialization.OptIn)]
    [GeneratedCode("NJsonSchema", "5.13.6167.23722")]
    public partial class QuotationsV1CreateInvoiceParameters : INotifyPropertyChanged
    { 
        private bool? _do;
        ...
        public static QuotationsV1CreateInvoiceParameters FromJson(string data)
        {
            return JsonConvert.DeserializeObject<QuotationsV1CreateInvoiceParameters>(data);
        }
