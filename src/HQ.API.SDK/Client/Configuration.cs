 ...
 * 
 * Changes have been made to this file by HQLabs GmbH.
 * 
 */
...
namespace HQSB.API.SDK.Client
{
    ...
    public class Configuration
    {
        ...
        public Configuration(ApiClient apiClient = null,
                             ...
                             int timeout = 100000,
                             string userAgent = "HQSB.API.Client.SDK/1.0.0/csharp"
                            )
        {
            BaseUrl = baseUrl;
            setApiClientUsingDefault(apiClient, baseUrl);
            ...
            {
                string key = ApiClient.Base64Encode(string.Format("{0}:{1}", username, password));
                _defaultHeaderMap.Add("Authorization", "Basic " + key);
            } else if(accessToken != null)
            {
                _defaultHeaderMap.Add("Authorization", "Bearer " + accessToken);
            }
        ...
        /// <returns></returns>
        public void setApiClientUsingDefault (ApiClient apiClient = null, string baseUrl = null)
        {
            if (apiClient == null)
            {
                if (Default != null && Default.ApiClient == null)
                    Default.ApiClient = new ApiClient(BaseUrl);

                ApiClient = Default != null ? Default.ApiClient : new ApiClient(BaseUrl);
            }
            else
            {
                if (Default != null && Default.ApiClient == null)
